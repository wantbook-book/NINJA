...
def default_compute_score(
    ...
    **kwargs,
    ...
    elif data_source == "code_localization":
        from . import code_localization

        res = code_localization.compute_score(
...
def get_default_compute_score(reward_name: str | None):
    ...
    elif reward_name == "code_localization":
        from .code_localization import compute_score as code_localization_compute_score

        return code_localization_compute_score
    else:
        return default_compute_score
