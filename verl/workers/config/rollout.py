...
class MultiTurnConfig(BaseConfig):
    ...
    # Multi-agent code localization fields
    training_role: Optional[str] = None
    navigator_tool_config_path: Optional[str] = None
    inspector_tool_config_path: Optional[str] = None
    remote_api_base: Optional[str] = None
    remote_api_key: Optional[str] = None
    remote_model_name: Optional[str] = None
    max_navigator_turns: Optional[int] = None
    max_inspector_turns: Optional[int] = None
    sub_agent_parallelism: Optional[int] = None
    length_penalty_coef: float = 1.0
    top_k_predictions: int = 5
    reward_metric: str = "dice"
    reward_acc_at_k: Any = None
