#!/bin/bash
# Phase 2: Train Navigator with DAPO
...
exp_name='navigator_dapo_training'
...
TRAIN_FILE=${TRAIN_FILE:-"${RAY_DATA_HOME}/data/code_loc/train.parquet"}
TEST_FILE=${TEST_FILE:-"${RAY_DATA_HOME}/data/code_loc/val.parquet"}
